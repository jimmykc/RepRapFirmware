...
constexpr size_t NumFirmwareUpdateModules = 1;		// 0 = mainboard, 4 = PanelDue, values in between unused
...
constexpr size_t MaxSpindles = 3;					// Maximum number of configurable spindles
