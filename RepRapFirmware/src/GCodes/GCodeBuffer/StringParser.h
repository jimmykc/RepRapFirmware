...
public:
	...
	bool HasModalCommandNumber() const noexcept { return hasModalCommandNumber; }
	int GetCommandNumber() const noexcept { return commandNumber; }
	float GetModalCommandNumber() const noexcept { return modalCommandNumber; }
